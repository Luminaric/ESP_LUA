...
local a=0
gpio.mode(e,gpio.OUTPUT)gpio.write(e,gpio.HIGH)tmr.delay(100)gpio.write(e,gpio.LOW)tmr.delay(100)gpio.write(e,gpio.HIGH)gpio.mode(e,gpio.INPUT)while(i(e)==0)do end
local n=0
